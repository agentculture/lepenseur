...
Takes zero or more path tokens and resolves them via :mod:`model_gear.explain`.
...
from model_gear.explain import resolve
...
def register(sub: argparse._SubParsersAction) -> None:
    ...
    p.add_argument(
        "path",
        nargs="*",
        help="Topic path tokens; empty = root (same as 'model-gear').",
    )

...
See :mod:`model_gear.explain.catalog` for the string bodies and :func:`resolve`
for lookup.
"""
...
from model_gear.explain.catalog import ENTRIES
...
def resolve(path: tuple[str, ...]) -> str:
    ...
    raise ModelGearError(
        ...
        remediation="list known topics with: model explain model-gear",
    )
